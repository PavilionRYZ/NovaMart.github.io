...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getProducts({ limit: 12 }))
      .unwrap()
      .then((data) => {
        // console.log("getProducts succeeded with data:", data);
      })
      .catch((err) => {
    ...
    return () => {
      console.log("Clearing product state on unmount...");
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      >
        <AnimatePresence mode="wait" custom={currentSlide}>
          ...
          >
            <div
              className={`absolute inset-0 bg-gradient-to-r ${carouselImages[currentSlide].gradient} z-10`}
            />
            <img
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <motion.div className="flex flex-col items-center group" variants={itemVariants} whileHover={{ scale: 1.05 }}>
              <motion.div
              ...
              <h3 className="text-4xl font-black mb-3 bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">
                50K+
              </h3>
            ...
            <motion.div className="flex flex-col items-center group" variants={itemVariants} whileHover={{ scale: 1.05 }}>
              ...
              <h3 className="text-4xl font-black mb-3 bg-gradient-to-r from-green-300 to-emerald-300 bg-clip-text text-transparent">
                10K+
              </h3>
            ...
            <motion.div className="flex flex-col items-center group" variants={itemVariants} whileHover={{ scale: 1.05 }}>
              ...
              <h3 className="text-4xl font-black mb-3 bg-gradient-to-r from-pink-300 to-rose-300 bg-clip-text text-transparent">
                5★
              </h3>
          ...
          >
            <div className="bg-red-50 border border-red-200 rounded-2xl p-12 max-w-md mx-auto shadow-lg">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  onClick={() => dispatch(getProducts({ limit: 12 }))}
