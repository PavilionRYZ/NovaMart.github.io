...
import { User, Edit, Lock, LogOut, Camera, Package, Mail, Phone, Upload, Store } from 'lucide-react';
                                    ...
                                    >
                                        ...
                                        {user?.role === 'seller' && (
                                            <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                                                <Button
                                                    asChild
                                                    className="w-full h-14 bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl border-0"
                                                >
                                                    <Link to="/seller-dashboard" className="flex items-center justify-center gap-3">
